...
My Query: ${text}`;
    ...
    try {
        ...
        if (!chatHistory || chatHistory.length === 0 || chatHistory[0].role !== 'system') {
            ...
            const systemPrompt = `You are Xkaliber Agent v34, a conversational AI assistant (AMD Optimized). You have access to persistent vector memory, web search, and system tools. Respond naturally and conversationally to the user. Do not invoke tools for casual conversation or greetings.
